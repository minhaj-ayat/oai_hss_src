...
void convert_ascii_to_binary(
  ...
  std::cout<<"In convert_ascii_to_binary"<<std::endl;
  for (i = 0; i < length; i++)
  {
    std::cout<< int(dest[i])<<" ";
  }
...
bool DataAccess::checkImsiExists(const char* imsi) {
  ...
  std::cout<<"checkImsiExists called : "<<imsi<<std::endl;
...
bool DataAccess::getImsiFromMsisdn(int64_t msisdn, std::string& imsi) {
  ...
  std::cout<<"getImsiFromMsisdn called, msisdn: "<<msisdn<<std::endl;
...
bool DataAccess::getMsisdnFromImsi(const char* imsi, std::string& msisdn) {
  ...
  std::cout<<"getMsisdnFromImsi called, imsi: "<<imsi<<std::endl;
...
bool DataAccess::getImsiInfo(
  ...
  std::cout<<"getImsiInfo called, imsi: "<<imsi<<std::endl;
...
bool DataAccess::getEventIdsFromMsisdn(
  ...
  std::cout<<"getEventIdsfromMsisdn called, imsi: "<<msisdn<<std::endl;
...
bool DataAccess::updateOpc(std::string& imsi, std::string& opc) {
  ...
  std::cout<<"updateOpc called, imsi: "<<imsi<<std::endl;
...
bool DataAccess::purgeUE(std::string& imsi) {
  ...
  std::cout<<"purgeUE called, imsi: "<<imsi<<std::endl;
...
bool DataAccess::getMmeIdentityFromImsi(
  ...
  std::cout<<"getMMEidentityfromImsi  called, imsi: "<<imsi<<std::endl;
...
bool DataAccess::getMmeIdFromHost(
  ...
  std::cout<<"getMMEidFromhost called, host: "<<host<<std::endl;
...
bool DataAccess::updateLocation(
  ...
  std::cout<<"updateLocation called"<<std::endl;
...
bool DataAccess::getImsiSecData(SCassFuture& future, DAImsiSec& imsisec) {
  ...
  if (row.valid()) {
    ...
    std::cout<<"(In getImsiSecData)"<<std::endl;
    std::cout<<"key_str : "<<key_str<<std::endl;
    std::cout<<"sqn : "<<sqn_nb<<std::endl;
    std::cout<<"rand_str : "<<rand_str<<std::endl;
    std::cout<<"opc_str : "<<OPc_str<<std::endl;
    std::cout<<"(Out of getImsiSecData)"<<std::endl;
...
bool DataAccess::getImsiSec(
  ...
  std::cout<<"getImsiSec called, imsi: "<<imsi<<std::endl;
...
bool DataAccess::updateRandSqn(
  ...
  std::cout<<"updateRandSqn called, imsi: "<<imsi<<std::endl;
...
bool DataAccess::incSqn(std::string& imsi, uint8_t* sqn) {
  ...
  std::cout<<"incSqn called, imsi: "<<imsi<<std::endl;
...
bool DataAccess::getSubDataFromImsi(const char* imsi, std::string& sub_data) {
  ...
  std::cout<<"getSubDataFromImsi called, imsi: "<<imsi<<std::endl;
...
void DataAccess::UpdateValidityTime(
  ...
  std::cout<<"updateValidityTime called, imsi: "<<imsi<<std::endl;
...
void DataAccess::UpdateNIRDestination(
  ...
  std::cout<<"updateNIRDestination called, imsi: "<<imsi<<std::endl;
